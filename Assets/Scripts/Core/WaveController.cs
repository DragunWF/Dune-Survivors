...
public sealed class WaveController : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        waves = new Wave[]
        {
            ...
            new(30, 2.5f, 2, 2),  // Wave 2 (~24 enemies)
            new(45, 2.2f, 2, 2),  // Wave 3 (~40 enemies)
            new(60, 2.5f, 2, 3),  // Wave 4 (~48 enemies)
            new(75, 2.2f, 2, 3),  // Wave 5 (~68 enemies)
            new(90, 2.0f, 2, 4),  // Wave 6 (90 enemies)
            new(105, 1.8f, 2, 4), // Wave 7 (~116 enemies)
            new(120, 1.8f, 2, 5), // Wave 8 (~133 enemies)
            new(135, 1.8f, 2, 5), // Wave 9 (150 enemies)
            new(150, 1.6f, 2, 6)  // Wave 10 (~187 enemies)
        };
    }
